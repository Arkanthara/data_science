...
\begin{enumerate}
    ...
    A vector space is a set of vectors where it's possible to make basics operations on vectors
    and that respects the commutativity, the associativity, the distributivity and where it exist a neutral element.
